    ...
    <aside class="sidebar g-col g-span3--mid u-showAboveMid">
      <nav>
        <ul class="controlList unstyled">
          <li class="controlList-item "> <a href="file:///C|/Users/ricky/git/justEat/justeat-ingsw-siw-demo/justeat-ingsw-siw-demo-war/src/main/webapp/userPanel.html" id="account-nav-link">Account</a> </li>
          <li class="controlList-item is-active "> <a href="file:///C|/Users/ricky/git/justEat/justeat-ingsw-siw-demo/justeat-ingsw-siw-demo-war/src/main/webapp/userOrders.html" id="orders-nav-link">Ordini</a> </li>
          ...
          <li class="controlList-item "> <a id="payment-nav-link" href="/member/savedcards">Inserisci Menù Ristorante</a> </li>
        </ul>
      </nav>
    </aside>
